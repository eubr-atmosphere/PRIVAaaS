...
public class Anonymizer extends Probe {
    ...
    */    
    ...
    private final static Logger log = LoggerFactory.getLogger(Anonymizer.class);
    ...
    */
    ...
    private InputStream      __csv;
    private DataSource       __source;
    ...
    */
    public static void main(String[] args) throws Exception, IOException {
	    ...
	    /* Set to true enable the "Anonymizer" send the result to stdout.*/
            obj.screen = true;

	    /* Load the configfile: contain parameter to execute the PRIVAaaS*/
	    ...
	    /* Get the result: content anonymized presented in JSON format. */
            obj.get_json_anonymized();

	    /* Show the resuls and save content in file. */
            obj.show_results();
    ...
    */
    public void prepare_source(String datasetFile, String pFile) throws 
        ...
        this.__source = DataSource.createCSVSource(datasetFile, 
        ...
        for (int i = 0; i < this.__policyJsonArray.size(); ++i) {
            ...
            this.__source.addColumn(field, DataType.STRING);
        }
    }
 

    private void __populate_data() throws IOException, Exception {
        try {
            this.dataAll = Data.create(this.__source);
        }
    ...
    */
	...
	Map<String, String> dictionary = new HashMap<String, String>();
        ...
        if (this.publish == true) {
            ...
            while (true) {                    
		System.out.println("Send informations to monitor! Loop: " + idx);

                /* 
		 * Publish the results to monitor.
		 */
                dictionary = this.publish_message_monitor();

                /* LOG: */
 	        log.info("Action received: " + dictionary.get("ACTION"));

                if (Objects.equals( dictionary.get("ACTION"), "UPDATE")) {
		    this.k = this.k + 10;
                    this.anonymize();
		    ...
		    if (!Objects.equals(dictionary.get("ACTION"),"NONE")){
 	                log.error("Problem: " + dictionary.get("ACTION"));
		    }
	            break;
	        }
	    }
    ...
    /*
        ...
        -----------------------------------------------------------------------
    */
    public void anonymize() throws IOException, Exception {
    ...
    */
     ...
     * ------------------------------------------------------------------------
     */
    public Map<String, String> publish_message_monitor() throws IOException,
                                                       ClassNotFoundException {
    
	Map<String, String> valRet = new HashMap<String, String>();
        ...
        valRet = this.publish_message(this.__endpoint,
